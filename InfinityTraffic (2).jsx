...
const ASSETS = [
  ...
  { id:'f29', name:'USD/SGD',  price:'1,3450',  absChange:'0,00',   change:'0,02%',  type:AssetType.FOREX,  flag:'🇺🇸🇸🇬', open:'1,3310',  high:'1,3200',  low:'1,3410',  prev:'1,3450'  },
  { id:'c1',  name:'BNB/USDT', price:'642,12',   absChange:'8,12',   change:'+1,42%', type:AssetType.CRYPTO, flag:'🟡', open:'634,09',  high:'650,45',  low:'632,12',  prev:'634,00'  },
  { id:'c2',  name:'BTC/USDT', price:'95840,50', absChange:'1945,30',change:'+2,14%', type:AssetType.CRYPTO, flag:'🟠', open:'93265,20',high:'96120,00',low:'93000,50',prev:'93265,00' },
  { id:'c3',  name:'ETH/USDT', price:'2712,12',  absChange:'48,15',  change:'+1,85%', type:AssetType.CRYPTO, flag:'💎', open:'2664,97', high:'2740,00', low:'2660,12', prev:'2665,00'  },
  { id:'c4',  name:'LTC/USDT', price:'92,42',    absChange:'1,12',   change:'+1,32%', type:AssetType.CRYPTO, flag:'⚪', open:'91,09',   high:'94,45',   low:'90,12',   prev:'91,00'   },
  { id:'c5',  name:'MNT/USDT', price:'0,7842',   absChange:'0,01',   change:'+1,52%', type:AssetType.CRYPTO, flag:'🟣', open:'0,7709',  high:'0,7945',  low:'0,7612',  prev:'0,7700'  },
  { id:'c6',  name:'SOL/USDT', price:'184,42',   absChange:'3,12',   change:'+2,12%', type:AssetType.CRYPTO, flag:'🟢', open:'181,09',  high:'188,45',  low:'180,12',  prev:'181,00'  },
  { id:'c7',  name:'XAUT/USDT',price:'2745,42',  absChange:'5,12',   change:'+0,22%', type:AssetType.CRYPTO, flag:'🪙', open:'2740,09', high:'2755,45', low:'2738,12', prev:'2740,00'  },
  { id:'c8',  name:'XRP/USDT', price:'0,6242',   absChange:'0,01',   change:'+1,12%', type:AssetType.CRYPTO, flag:'🔵', open:'0,6109',  high:'0,6445',  low:'0,6012',  prev:'0,6100'  },
  { id:'c9',  name:'ZEC/USDT', price:'38,42',    absChange:'0,42',   change:'+1,22%', type:AssetType.CRYPTO, flag:'🛡️', open:'37,09',   high:'40,45',   low:'36,12',   prev:'37,00'   },
  { id:'m1',  name:'GOLD',      price:'2741,22',  absChange:'7,85',   change:'+0,34%', type:AssetType.METALS, flag:'🌕', open:'2733,37', high:'2750,00', low:'2730,12', prev:'2733,37'  },
  { id:'m2',  name:'SILVER',    price:'31,22',    absChange:'0,15',   change:'+0,54%', type:AssetType.METALS, flag:'⚪', open:'31,07',   high:'31,50',   low:'31,00',   prev:'31,07'   },
  { id:'m3',  name:'PLATINUM',  price:'965,22',   absChange:'2,85',   change:'+0,30%', type:AssetType.METALS, flag:'💍', open:'962,37',  high:'970,00',  low:'960,12',  prev:'962,37'  },
  { id:'m4',  name:'PALLADIUM', price:'1040,22',  absChange:'5,85',   change:'+0,58%', type:AssetType.METALS, flag:'💎', open:'1034,37', high:'1050,00', low:'1030,12', prev:'1034,37'  },
];

const TRANSLATIONS = {
  RU: {
    brand:'⃟𝐈𝐍𝐅𝐈𝐍𝐈𝐓𝐘', brandTraffic:'𝐓𝐑𝐀𝐅𝐅𝐈𝐂™',
    heroDesc:'Получайте точные сигналы для успешной торговли',
    statusLabel:'ВАШ СТАТУС', limitsLabel:'ДОСТУПНО СИГНАЛОВ',
    selectAssetTitle:'ВЫБЕРИТЕ АКТИВ', selectTfTitle:'ВЫБЕРИТЕ ПЕРИОД',
    backToMenu:'ВЕРНУТЬСЯ', signalBuy:'ВЫШЕ (CALL)', signalSell:'НИЖЕ (PUT)',
    confirmed:'УСПЕШНО', failed:'НЕУДАЧНО', newCycle:'НОВЫЙ ПРОГНОЗ',
    statusStandard:'СТАНДАРТ', statusElite:'Верифицирован', statusVip:'VIP ДОСТУП',
    changeStatus:'ИЗМЕНИТЬ', searchAsset:'ПОИСК АКТИВА...', tfDesc:'Выберите временной интервал для анализа',
    accuracyLabel:'ВЕРОЯТНОСТЬ', timeframe:'ПЕРИОД', modalTitle:'АКТИВАЦИЯ',
    modalConfirm:'АКТИВИРОВАТЬ', enterPw:'ВВЕДИТЕ КОД ДОСТУПА',
    limitReached:'ЛИМИТ ИСЧЕРПАН', unlimited:'БЕЗЛИМИТНО',
    supportSupport:'ПОДДЕРЖКА', supportMessage:'Свяжитесь с поддержкой для получения кода доступа',
    resetIn:'ОБНОВЛЕНИЕ ЧЕРЕЗ', typeForex:'ВАЛЮТЫ', typeCrypto:'КРИПТО', typeMetals:'МЕТАЛЛЫ',
    analyzing:'АНАЛИЗ РЫНКА', noResults:'НИЧЕГО НЕ НАЙДЕНО', vipOnly:'ТОЛЬКО ДЛЯ VIP',
    community:'СООБЩЕСТВО', supportCenter:'ЦЕНТР ПОДДЕРЖКИ', officialChannel:'ОФИЦИАЛЬНЫЙ КАНАЛ',
    quantumFeed:'КВАНТОВЫЙ ПОТОК', realTime:'LIVE ДАННЫЕ', startBtn:'НАЧАТЬ', analysisBtn:'АНАЛИЗ',
    pageLabel:'Страница', marketClosed:'РЫНОК ЗАКРЫТ', reopeningIn:'ОТКРЫТИЕ ЧЕРЕЗ',
  ...
  <header style={{position:'sticky',top:0,zIndex:100,background:'rgba(11,14,17,0.9)',backdropFilter:'blur(20px)',borderBottom:'1px solid rgba(255,255,255,0.05)',minHeight:'84px',display:'flex',alignItems:'center',justifyContent:'space-between',padding:'0 20px'}}>
    <div style={{display:'flex',alignItems:'center',gap:'16px',marginTop:'8px'}}>
      <div style={{display:'flex',flexDirection:'column',alignItems:'center',gap:'6px'}}>
        ...
        <span style={{fontSize:'9px',fontWeight:900,color:'rgba(255,255,255,0.3)',textTransform:'uppercase',letterSpacing:'0.1em'}}>{lang==='RU'?'Главная':'Home'}</span>
      </div>
      <div style={{display:'flex',flexDirection:'column',alignItems:'center',gap:'6px'}}>
        ...
        <span style={{fontSize:'9px',fontWeight:900,color:'rgba(255,255,255,0.3)',textTransform:'uppercase',letterSpacing:'0.1em'}}>{lang==='RU'?'Новости':'News'}</span>
      </div>
    </div>
...
const useForexMarketStatus = () => {
  ...
  useEffect(() => {
    const update = () => {
      ...
      const timeLeft = dd > 0
        ? `${dd}д ${String(hh).padStart(2,'0')}:${String(mm).padStart(2,'0')}:${String(ss).padStart(2,'0')}`
        ...
        {activeTab === AssetType.FOREX && forexMarket.closed && (
          <div style={{background:'linear-gradient(135deg,rgba(246,70,93,0.1),rgba(11,14,17,0.95))',border:'1px solid rgba(246,70,93,0.4)',borderRadius:'24px',padding:'20px 24px',marginBottom:'16px',display:'flex',flexDirection:'column',alignItems:'center',gap:'10px',boxShadow:'0 0 30px rgba(246,70,93,0.1)'}}>
            <div style={{display:'flex',alignItems:'center',gap:'10px'}}>
              ...
              <span style={{fontSize:'12px',fontWeight:900,color:'#f6465d',textTransform:'uppercase',letterSpacing:'0.3em'}}>{t.marketClosed || 'РЫНОК ЗАКРЫТ'}</span>
            </div>

            <div style={{display:'flex',flexDirection:'column',alignItems:'center',gap:'4px'}}>
              <span style={{fontSize:'9px',fontWeight:900,color:'rgba(255,255,255,0.3)',textTransform:'uppercase',letterSpacing:'0.3em'}}>{t.reopeningIn || 'ОТКРЫТИЕ ЧЕРЕЗ'}</span>
          ...
          <div style={{padding:'24px',display:'flex',flexDirection:'column',gap:'24px'}}>
            ...
            <div style={{display:'flex',alignItems:'center',justifyContent:'space-between'}}>
              <div style={{display:'flex',flexDirection:'column',gap:'4px'}}>
                ...
                <div style={{display:'flex',alignItems:'center',gap:'8px'}}>
                  {isVip && <span style={{fontSize:'30px',color:'white'}}>∞</span>}
